import CJS_COMPAT_NODE_URL_dr6fo50wb35 from 'node:url';
import CJS_COMPAT_NODE_PATH_dr6fo50wb35 from 'node:path';
import CJS_COMPAT_NODE_MODULE_dr6fo50wb35 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_dr6fo50wb35.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_dr6fo50wb35.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_dr6fo50wb35.createRequire(import.meta.url);
...
var core = {
  ...
  if ((await presets.apply("features", {}))?.experimentalDocgenServer)
    return config;
  ...
  if (reactDocgenOption === "react-docgen-typescript" && typescriptPresent && plugins.push(
    ...
    let { reactDocgen } = await import("./_node-chunks/react-docgen-TKCLAXAS.js");
    plugins.unshift(
