...
// src/preview-api/modules/preview-web/UrlStore.ts
var { history, document: document2 } = global7, PATH_REGEX = /^\/(story|docs)\/(.+)/;
...
var getQueryString = ({
  ...
  if (typeof document2 < "u") {
    let queryStr = document2.location.search.slice(1), query = parse(queryStr), args = typeof query.args == "string" ? parseArgsParam(query.args) : void 0, globals = typeof query.globals == "string" ? parseArgsParam(query.globals) : void 0, path = getFirstString(query.path), viewMode = getFirstString(query.viewMode);
